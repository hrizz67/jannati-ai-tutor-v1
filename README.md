...
React + Vite learning app for Malaysian Year 2 revision with split subject banks, learning path, PBD summative assessment, AI explain/teacher helpers, parent dashboard, and offline-friendly GitHub Pages deployment.
