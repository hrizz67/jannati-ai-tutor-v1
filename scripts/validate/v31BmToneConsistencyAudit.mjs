...
assert.match(teacher.simpleExplanation, /“Saya” dipilih berdasarkan/i);
...
assert.match(taught.explanation, /kata ganti nama|Gunakan “Saya”|“Saya” (?:digunakan|dipilih)/i);
