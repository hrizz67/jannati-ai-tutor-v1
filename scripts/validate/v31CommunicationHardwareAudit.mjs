...
const voice = fs.readFileSync('src/ai/voice/browserVoiceProvider.js', 'utf8');
...
assert.match(communication, /playCommunicationAudio/);
...
assert.doesNotMatch(bertuturSource, /new SpeechRecognition|new window\.SpeechRecognition/);
