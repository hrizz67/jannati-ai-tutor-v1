...
function BertuturCoach({ resume, onResumeChange, onClearResume, onBack, onFinish }) {
  ...
  const prompt = set?.prompts?.[mode] || set?.prompts?.intro || Object.values(set?.prompts || {})[0] || { label: 'Soalan', text: '', keywords: [] };
