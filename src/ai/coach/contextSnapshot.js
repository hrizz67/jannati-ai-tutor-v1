...
export function resolveCoachContextSnapshot({
  ...
  const languagePresentation = getSubjectLanguagePresentation(questionSubjectId);
  const snapshot = {
    requestId,
    ...
    sourceLanguage: text(question?.language || topic?.language || subject?.language || languagePresentation.contentLanguage),
    sourceLocale: languagePresentation.contentLocale,
    teachingLanguage: languagePresentation.teachingLanguage,
    teachingLocale: languagePresentation.teachingLocale,
