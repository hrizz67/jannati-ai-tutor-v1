...
export default createKnowledgePack({
  ...
  "teacherExplanation": [
    "Topik Anggota Badan membantu murid memahami asas yang dijelaskan dalam nota ini.",
    "Guru boleh menerangkan Anggota Badan dengan contoh yang dekat dengan kehidupan harian murid.",
  ...
  "memoryTips": [
    "Ingat Anggota Badan melalui contoh mudah.",
  ...
  "commonMistakes": [
    "Tersalah memilih jawapan yang tidak berkaitan dengan Anggota Badan.",
  ...
  "encouragement": {
    "correct": [
      "Bagus! Kamu memahami Anggota Badan dengan baik.",
    ...
    "retry": [
      "Tak mengapa, cuba semak Anggota Badan sekali lagi.",
    ...
    "excellent": [
      "Hebat! Kamu sangat mahir dengan Anggota Badan.",
  ...
  "difficulty": "easy",
  "curriculum": {
    "SK": "Mengenal anggota badan dalam bahasa Arab.",
    "SP": "Murid dapat memadankan dan menyebut anggota badan dengan betul."
  },
  "keywords": [
    "rās",
    "ain",
  ...
  "questionPatterns": [
    ...
    "Yang manakah contoh anggota badan?",
  ...
  "letterRecognitionTips": [
    "Perhatikan bentuk huruf dalam Anggota Badan.",
  ...
  "writingTips": [
    "Tulis Anggota Badan dari kanan ke kiri.",
  ...
  "translationHints": [
    "Padankan Anggota Badan dengan maksud Melayu.",
  ...
  "readingPractice": [
    "Baca contoh Anggota Badan satu demi satu.",
  ...
  "speakingPractice": [
    "Sebut Anggota Badan dengan jelas.",
  ...
  "writingPractice": [
    "Salin Anggota Badan dengan kemas.",
