...
export default createKnowledgePack({
  ...
  "teacherExplanation": [
    "Topik Ayat Mudah membantu murid memahami asas yang dijelaskan dalam nota ini.",
    "Guru boleh menerangkan Ayat Mudah dengan contoh yang dekat dengan kehidupan harian murid.",
  ...
  "tips": [
    "Baca soalan tentang Ayat Mudah dengan teliti.",
  ...
  "memoryTips": [
    "Ingat Ayat Mudah melalui contoh mudah.",
  ...
  "commonMistakes": [
    "Tersalah memilih jawapan yang tidak berkaitan dengan Ayat Mudah.",
  ...
  "letterRecognitionTips": [
    "Perhatikan bentuk huruf dalam Ayat Mudah.",
  ...
  "translationHints": [
    "Padankan Ayat Mudah dengan maksud Melayu.",
  ...
  "readingPractice": [
    "Baca contoh Ayat Mudah satu demi satu.",
