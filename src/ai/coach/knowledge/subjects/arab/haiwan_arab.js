...
export default createKnowledgePack({
  ...
  "teacherExplanation": [
    "Topik Haiwan membantu murid memahami asas yang dijelaskan dalam nota ini.",
    "Guru boleh menerangkan Haiwan dengan contoh yang dekat dengan kehidupan harian murid.",
  ...
  "memoryTips": [
    "Ingat Haiwan melalui contoh mudah.",
  ...
  "commonMistakes": [
    "Tersalah memilih jawapan yang tidak berkaitan dengan Haiwan.",
  ...
  "difficulty": "easy",
  "curriculum": {
    "SK": "Mengenal nama haiwan dalam bahasa Arab.",
    "SP": "Murid dapat memadankan dan menyebut nama haiwan dengan betul."
  },
  "keywords": [
    "haiwan",
    "qitta",
  ...
  "letterRecognitionTips": [
    "Perhatikan bentuk huruf dalam Haiwan.",
  ...
  "writingTips": [
    "Tulis Haiwan dari kanan ke kiri.",
  ...
  "translationHints": [
    "Padankan Haiwan dengan maksud Melayu.",
  ...
  "readingPractice": [
    "Baca contoh Haiwan satu demi satu.",
