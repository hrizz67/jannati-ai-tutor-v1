...
export default createKnowledgePack({
  ...
  "teacherExplanation": [
    "Topik Hiwar membantu murid memahami asas yang dijelaskan dalam nota ini.",
    "Guru boleh menerangkan Hiwar dengan contoh yang dekat dengan kehidupan harian murid.",
  ...
  "tips": [
    "Baca soalan tentang Hiwar dengan teliti.",
  ...
  "memoryTips": [
    "Ingat Hiwar melalui contoh mudah.",
  ...
  "commonMistakes": [
    "Tersalah memilih jawapan yang tidak berkaitan dengan Hiwar.",
  ...
  "translationHints": [
    "Padankan Hiwar dengan maksud Melayu.",
