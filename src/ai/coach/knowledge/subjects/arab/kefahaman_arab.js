...
export default createKnowledgePack({
  ...
  "teacherExplanation": [
    "Topik Kefahaman Arab membantu murid memahami asas yang dijelaskan dalam nota ini.",
    "Guru boleh menerangkan Kefahaman Arab dengan contoh yang dekat dengan kehidupan harian murid.",
  ...
  "tips": [
    "Baca soalan tentang Kefahaman Arab dengan teliti.",
  ...
  "memoryTips": [
    "Ingat Kefahaman Arab melalui contoh mudah.",
  ...
  "commonMistakes": [
    "Tersalah memilih jawapan yang tidak berkaitan dengan Kefahaman Arab.",
  ...
  "letterRecognitionTips": [
    "Perhatikan bentuk huruf dalam Kefahaman Arab.",
  ...
  "writingTips": [
    "Tulis Kefahaman Arab dari kanan ke kiri.",
  ...
  "translationHints": [
    "Padankan Kefahaman Arab dengan maksud Melayu.",
  ...
  "readingPractice": [
    "Baca contoh Kefahaman Arab satu demi satu.",
  ...
  "speakingPractice": [
    "Sebut Kefahaman Arab dengan jelas.",
  ...
  "writingPractice": [
    "Salin Kefahaman Arab dengan kemas.",
