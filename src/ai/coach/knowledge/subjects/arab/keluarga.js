...
export default createKnowledgePack({
  ...
  "teacherExplanation": [
    "Topik Ahli Keluarga membantu murid memahami asas yang dijelaskan dalam nota ini.",
    "Guru boleh menerangkan Ahli Keluarga dengan contoh yang dekat dengan kehidupan harian murid.",
  ...
  "memoryTips": [
    "Ingat Ahli Keluarga melalui contoh mudah.",
  ...
  "commonMistakes": [
    "Tersalah memilih jawapan yang tidak berkaitan dengan Ahli Keluarga.",
  ...
  "encouragement": {
    "correct": [
      "Bagus! Kamu memahami Ahli Keluarga dengan baik.",
    ...
    "retry": [
      "Tak mengapa, cuba semak Ahli Keluarga sekali lagi.",
    ...
    "excellent": [
      "Hebat! Kamu sangat mahir dengan Ahli Keluarga.",
  ...
  "difficulty": "easy",
  "curriculum": {
    "SK": "Mengenal ahli keluarga dalam bahasa Arab.",
    "SP": "Murid dapat memadankan dan menyebut ahli keluarga dengan betul."
  },
  "keywords": [
    "ayah",
    "ibu",
  ...
  "questionPatterns": [
    "Apakah yang berkaitan dengan Ahli Keluarga?",
    "Pilih jawapan yang betul.",
    "Yang manakah contoh ahli keluarga?",
  ...
  "letterRecognitionTips": [
    "Perhatikan bentuk huruf dalam Ahli Keluarga.",
  ...
  "writingTips": [
    "Tulis Ahli Keluarga dari kanan ke kiri.",
  ...
  "translationHints": [
    "Padankan Ahli Keluarga dengan maksud Melayu.",
  ...
  "readingPractice": [
    "Baca contoh Ahli Keluarga satu demi satu.",
  ...
  "speakingPractice": [
    "Sebut Ahli Keluarga dengan jelas.",
  ...
  "writingPractice": [
    "Salin Ahli Keluarga dengan kemas.",
