...
export default createKnowledgePack({
  ...
  "encouragement": {
    "correct": [
      "Bagus! Kamu memahami Mufradat dengan baik.",
    ...
    "retry": [
      "Tak mengapa, cuba semak Mufradat sekali lagi.",
    ...
    "excellent": [
      "Hebat! Kamu sangat mahir dengan Mufradat.",
  ...
  "difficulty": "easy",
  "curriculum": {
    "SK": "Mengenal mufradat asas bahasa Arab.",
    "SP": "Murid dapat memadankan perkataan Arab dengan maksud yang sesuai."
  },
  "keywords": [
    "mufradat",
    "kosa kata",
