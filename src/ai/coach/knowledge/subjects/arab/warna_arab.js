...
export default createKnowledgePack({
  ...
  "teacherExplanation": [
    "Topik Warna membantu murid memahami asas yang dijelaskan dalam nota ini.",
    "Guru boleh menerangkan Warna dengan contoh yang dekat dengan kehidupan harian murid.",
  ...
  "memoryTips": [
    "Ingat Warna melalui contoh mudah.",
  ...
  "commonMistakes": [
    "Tersalah memilih jawapan yang tidak berkaitan dengan Warna.",
  ...
  "encouragement": {
    "correct": [
      "Bagus! Kamu memahami Warna dengan baik.",
    ...
    "retry": [
      "Tak mengapa, cuba semak Warna sekali lagi.",
    ...
    "excellent": [
      "Hebat! Kamu sangat mahir dengan Warna.",
  ...
  "difficulty": "easy",
  "curriculum": {
    "SK": "Mengenal warna asas dalam bahasa Arab.",
    "SP": "Murid dapat memadankan dan menyebut warna dengan betul."
  },
  "keywords": [
    "warna",
    "merah",
  ...
  "questionPatterns": [
    "Apakah yang berkaitan dengan Warna?",
    "Pilih jawapan yang betul.",
    "Yang manakah contoh warna?",
  ...
  "letterRecognitionTips": [
    "Perhatikan bentuk huruf dalam Warna.",
  ...
  "writingTips": [
    "Tulis Warna dari kanan ke kiri.",
  ...
  "translationHints": [
    "Padankan Warna dengan maksud Melayu.",
  ...
  "readingPractice": [
    "Baca contoh Warna satu demi satu.",
