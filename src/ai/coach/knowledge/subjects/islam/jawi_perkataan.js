...
export default createKnowledgePack({
  "subjectId": "islam",
  ...
  "teacherExplanation": [
    "Topik Perkataan Jawi membantu murid memahami asas yang dijelaskan dalam nota ini.",
    "Guru boleh menerangkan Perkataan Jawi dengan contoh yang dekat dengan kehidupan harian murid.",
  ...
  "tips": [
    "Baca soalan tentang Perkataan Jawi dengan teliti.",
  ...
  "memoryTips": [
    "Ingat Perkataan Jawi melalui contoh mudah.",
  ...
  "commonMistakes": [
    "Tersalah memilih jawapan yang tidak berkaitan dengan Perkataan Jawi.",
  ...
  "encouragement": {
    "correct": [
      "Bagus! Kamu memahami Perkataan Jawi dengan baik.",
    ...
    "retry": [
      "Tak mengapa, cuba semak Perkataan Jawi sekali lagi.",
    ...
    "excellent": [
      "Hebat! Kamu sangat mahir dengan Perkataan Jawi.",
  ...
  "difficulty": "easy",
  "curriculum": {
    "SK": "Mengenal dan membaca perkataan Jawi asas.",
    "SP": "Murid dapat memadankan dan menulis perkataan Jawi mudah."
  },
  "keywords": [
    "perkataan",
    "jawi",
  ...
  "questionPatterns": [
    "Apakah yang berkaitan dengan Perkataan Jawi?",
    "Pilih jawapan yang betul.",
    "Yang manakah contoh perkataan jawi?",
  ...
  "dailyPractice": [
    "Ulang ilmu Perkataan Jawi setiap hari.",
  ...
  "adabApplications": [
    "Amalkan adab berkaitan Perkataan Jawi dalam kehidupan harian.",
  ...
  "realLifeExamples": [
    "Menggunakan Perkataan Jawi dalam situasi harian yang sesuai.",
  ...
  "ayahOrHadithReference": [
    "Tulisan Jawi memudahkan bacaan teks agama."
  ],
  "misconceptions": [
    "Menganggap Perkataan Jawi hanya hafalan tanpa amalan.",
  ...
  "reflectionQuestions": [
    "Apakah pengajaran utama tentang Perkataan Jawi?",
  ...
  "goodDeedsIdeas": [
    "Amalkan Perkataan Jawi dalam rutin harian.",
