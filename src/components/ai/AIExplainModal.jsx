...
export default function AIExplainModal({ open, data, context = null, question, character = 'jati', onTutup, onTryAgain, onTeach }) {
  ...
  const labels = isEnglish
    ? { offline: 'AI Explanation Offline', title: 'Explain', focus: 'Explanation focus', simple: 'Simple explanation', why: 'Why this answer is correct', answer: 'Correct answer', steps: 'Step-by-step example', extra: 'More examples', mistakes: 'Common mistakes', memory: 'Memory tip', followUp: 'Follow-up question', additional: 'View more help', read: 'Listen to Explanation', retry: 'Try again', close: 'Close', teach: 'Teach me' }
    : { offline: 'Penerangan AI Luar Talian', title: 'Terangkan', focus: 'Fokus penerangan', simple: 'Penerangan mudah', why: 'Kenapa jawapan itu betul', answer: 'Jawapan betul', steps: 'Contoh langkah demi langkah', extra: 'Contoh lain', mistakes: 'Kesilapan biasa', memory: 'Tip ingatan', followUp: 'Soalan susulan', additional: 'Lihat bahan tambahan', read: 'Dengar Penerangan', retry: 'Cuba Lagi', close: 'Tutup', teach: 'Ajar Saya' };
