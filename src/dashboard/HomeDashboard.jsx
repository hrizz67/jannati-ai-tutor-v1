  ...
  return (
    <DashboardLayout>
      ...
      <section className="dashboard-main">
        ...
        <section className="card home-continue-card"><button type="button" className="full" onClick={() => onStartAdaptiveLesson(learningJourney.todayLesson || smartLesson)}><IconGlyph name="play" motion="hover" /> <span>Sambung Belajar</span></button></section>
