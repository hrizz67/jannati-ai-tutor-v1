-- Jannati AI Tutor production schema baseline.
-- This file contains schema only: no production users or learning data.
...
grant execute on function public.get_learning_data() to service_role;
grant execute on function public.save_learning_data(jsonb) to service_role;
